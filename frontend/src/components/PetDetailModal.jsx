                                                    ...
                                                    <tbody>
                                                        {bestServers.map((server, i) => (
                                                            <tr key={server.realm_id}>
                                                                ...
                                                                <td style={{ color: (server.cancels_3d ?? 0) > 10 ? 'var(--color-warning)' : 'inherit' }}>{server.cancels_3d ?? 0}</td>
                                                ...
                                                {bestServers.map((server, i) => (
                                                    <div className={styles.mobileListItem} key={server.realm_id}>
                                                        ...
                                                        <div className={styles.mobileListRow}>
                                                            ...
                                                            <span style={{ color: (server.cancels_3d ?? 0) > 10 ? 'var(--color-warning)' : 'var(--text-muted)' }}>🔄 {server.cancels_3d ?? 0}</span>
                                                        </div>
                                                    </div>
                                                ))}
                                            </div>
